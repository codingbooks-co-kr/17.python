...
class ComputerStudent(Student):		# 자식 클래스1 (컴퓨터 전공 학생 클래스)
    ...
    def print_info(self):      			# 메서드 오버라이딩(=재정의, 덮어쓰기)
        super().print_info()			# 부모의 메서드 호출, 재사용
        print(f"코딩: {self.coding}점")
